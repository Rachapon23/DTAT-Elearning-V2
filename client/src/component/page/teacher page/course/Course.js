                        ...
                        <div className="card">
                            ...
                            <div className="card-body p-5">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <label className="form-label  mt-3">public or register</label>
                                        <div className="">
                                            <Switch defaultChecked={nameCourse.statuscourse} onChange={(e) => { setNameCourse({ ...nameCourse, statuscourse: e }) }} />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="d-flex justify-content-between mb-0 mt-4" >
                                    ...
                                    <button className="btn h4 text-primary mb-0"
                                        type='Button' onClick={(e) => handdleAddStudent(e)}
                                    >+</button>
                                </div>
                                <hr className="mt-0" />
                                ...
                                <div className="mt-5">
                                    <p>calendar</p>
                                    <CalendarForcourse nameCourse={nameCourse} setNextState={setNextState} nextState={nextState} />
                                    ...
                                    {nameCourse.calendar.map((ttem, tdex) =>
                                        <div key={tdex} className="mt-3">
                                            ...
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <p>end : {ttem.end}</p>
                                                <p style={{ color: `${ttem.color}` }}>color : {ttem.color}</p>
                                                <button
                                                    className="btn btn-outline-secondary"
                                                    onClick={(e) => handleRemoveStudent(e, tdex)}
                                                    type='Button'
