...
import {
  ...
  removeCourse,
  enablecourse,
} from "../../../../function/teacher/funcCourse";
          ...
          {topic &&
            topic.map((item, index) => (
              <div key={index} className="px-5 mt-3">
                <h5 id="titleTopic" className="fw-bold">
                  {item.title}
                </h5>
                <div className="">
                    ...
                    <div className="">
                      <ul>
                        {item.link.map((ttem, tdex) => (
                          <li key={tdex}>
                            <a className="text-info" href={ttem.url}>
                              <i className="bi bi-link"></i>&nbsp;{ttem.name}
                            </a>
                          </li>
                        ))}
                      </ul>
                          ...
                          {ttem.filetype === "image/jpeg" ? (
                            <div className="container">
                              <div className="d-flex justify-content-center">
                                <div className="w-50">
                                  <img
                                    src={`${process.env.REACT_APP_IMG}/${ttem.filename}`}
                                    className="w-100"
                                  />
                                </div>
                              </div>
